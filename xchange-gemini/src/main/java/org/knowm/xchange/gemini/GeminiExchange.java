...
import org.knowm.xchange.gemini.service.GeminiAccountService;
import org.knowm.xchange.gemini.service.GeminiMarketDataService;
import org.knowm.xchange.gemini.service.GeminiMarketDataServiceRaw;
import org.knowm.xchange.gemini.service.GeminiTradeService;
...
public class GeminiExchange extends BaseExchange {
  ...
  private static void concludeHostParams(ExchangeSpecification exchangeSpecification) {
    ...
    if (exchangeSpecification.getExchangeSpecificParameters() != null) {
      if (exchangeSpecification.getExchangeSpecificParametersItem(Exchange.USE_SANDBOX).equals(true)) {
        ...
        exchangeSpecification.setWsEndpoint("wss://api.sandbox.gemini.com");
      }
    }
  }
  ...
  public ExchangeSpecification getDefaultExchangeSpecification() {
    ...
    exchangeSpecification.setWsEndpoint("wss://api.gemini.com");
