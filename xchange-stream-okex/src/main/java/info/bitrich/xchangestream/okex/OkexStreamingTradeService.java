...
public class OkexStreamingTradeService implements StreamingTradeService {
  ...
  public Observable<UserTrade> getUserTrades(Instrument instrument, Object... args) {
    ...
    return service.subscribeChannel(channelUniqueId)
        ...
        .flatMap(jsonNode -> {
              List<OkexOrderDetails> okexOrderDetails = mapper.treeToValue(jsonNode.get("data"),
                  mapper.getTypeFactory().constructCollectionType(List.class, OkexOrderDetails.class));
