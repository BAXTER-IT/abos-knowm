...
import org.knowm.xchange.kucoin.dto.response.FundingHistoryResponse;
...
public interface FundingHistoryAPI {

  @GET
  KucoinResponse<FundingHistoryResponse> getFundingHistory(
